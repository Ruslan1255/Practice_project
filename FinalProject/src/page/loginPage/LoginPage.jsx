...
const Login = () => {
  ...
  return (
    <div className="container">
      <p className={style.loginPageGoback} onClick={() => navigate(-1)}>
        <MdKeyboardArrowLeft />
        Go Back
      </p>
          ...
          <div className={style.left}>
            <form className={style.form}>
              <div className={style.inputBlock}>
                <input
                  className={style.loginBoxInput}
                  type="text"
                  id="email"
                  required=""
                />
                <label className={style.loginBoxLabel} htmlFor="email">
                  Username
                </label>
              </div>
              <div className={style.inputBlock}>
                <input
                  ...
                  required=""
                />
                <label className={style.loginBoxLabel} htmlFor="pass">
                  Password
                </label>
              </div>
              <div className={style.inputBlock}>
                ...
                <button className={style.loginBox_button}>Submit</button>
              </div>
            </form>
          </div>
          <div className={style.right}>
            <div className="img">
              ...
              >
                ...
                ></path>
                <path
                  d="7087-27,13.57087c1,5,66,19,66,19,0,0-13-40-21-53-8-13-18.91632-113.97563-18.91632-113.97563Z"
                  fill="#3f3d56"
                ></path>
                <path
                  d="M452.48463,121.10598s-29-4-34,30c-5,34-1.82283,38.5-1.82283,38.5l-8.17717,19.5-27-30-26,17s47,76,66,74c19-2,47-57,47-57l-16-92Z"
