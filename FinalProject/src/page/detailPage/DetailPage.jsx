              ...
              <div className={style.product_info}>
                ...
                <div className={style.product_info_sale}>
                  <div className={style.product_info_sale_box}>
                    <span className={style.product_info_sale_box_price}>
                      $ {countPrice()}
                    </span>
                  </div>
                </div>
                <div className={style.product_buy}>
                  <div className={style.product_buy_counter}>
                    <span
                      className={style.product_buy_counter_minus}
                      onClick={handleDecreaseCount}
                    >
                      -
                    </span>
                    <span className={style.product_buy_counter_count}>
                      {count}
                    </span>
                    <span
                      className={style.product_buy_counter_plus}
                  ...
                  <div
                    ...
                    data-tooltip={count * product.price + " " + "$"}
      ...
      <div className={style.offerBox}>
        <div className="container">
          <div className="offerBox_card">
            <p className={style.offerBox_sameProduct_title}>
