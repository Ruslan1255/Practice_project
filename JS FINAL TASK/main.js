...
function addToCart(key) {
  if (cartItems[key] == null) {
      cartItems[key] = { ...data.products[key], quantity: 1, originalPrice: data.products[key].price };
  } else {
    ...
    if (cartItem != null) {
      ...
      cartItemDiv.innerHTML = `
                ...
                <div>
                    ...
                    <button onclick="changeQuantity(${key},${cartItem.quantity + 1})" class="plusBTN">+</button>
